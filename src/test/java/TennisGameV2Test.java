...
import v2.TennisGame;
import v2.model.Player;
import v2.model.score.PlayerScoreValue;


import java.util.stream.IntStream;

public class TennisGameV2Test {
    ...
    public void newGameShouldReturnLoveToLove() {
        Assertions.assertThat(tennisGame.displayScore()).isEqualTo(PlayerScoreValue.LOVE+"-"+PlayerScoreValue.LOVE);
    }
